...
<section class="page-hero">
  <div class="container">
    <h1>Our Wedding Fleet</h1>
    <p>From the iconic Rolls Royce Phantom to elegant vintage classics, our wedding car fleet is curated to create unforgettable arrivals for Asian and English Weddings across Lancashire, Yorkshire, Cumbria, Derbyshire and Nottinghamshire.</p>
  </div>
</section>
...
<section>
  <div class="container">
    ...
    <div style="text-align:center;margin-top:2.5rem;">
      <a href="<?php echo esc_url( home_url( '/wedding-quote/' ) ); ?>" class="btn primary">Get Your Wedding Quote</a>
    </div>
