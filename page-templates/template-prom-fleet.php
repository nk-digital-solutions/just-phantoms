...
<section class="page-hero">
  <div class="container">
    <h1>Our Prom Fleet</h1>
    <p>Arrive at Prom in style. From bold Limousines to an iconic supercharged Mustang, our prom car fleet makes a statement across Lancashire, Yorkshire, Cumbria, Derbyshire and Nottinghamshire.</p>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid g3" id="fleet-grid">
      ...
      $vehicles = array(
        ...
        array( 'category' => 'vintage',     'badge' => 'Vintage Style',     'href' => home_url('/our-fleet/regent-landaulette-convertible/'),   'img' => 'fleet/regent/regent-landaulette-convertible.png',           'alt' => 'Regent Landaulette Convertible',     'seats' => '6', 'name' => 'Regent Landaulette Convertible',    'desc' => 'Classic 1930s styling with modern reliability &mdash; a stunning and unique prom entrance.', 'price' => 'From &pound;350 per hire' ),
        array( 'category' => 'vintage',     'badge' => 'Classic Elegance',  'href' => home_url('/our-fleet/1930s-vintage-classic/'),            'img' => "fleet/vintage/1930's Vintage Classic Car.jpg",              'alt' => "1930's Vintage Classic Car",         'seats' => '3', 'name' => "1930&#39;s Vintage Classic Car",    'desc' => 'Timeless glamour and authentic period styling &mdash; creates stunning photos and cinematic moments.', 'price' => 'From &pound;295 per hire' ),
      );
    ...
    <div style="text-align:center;margin-top:2.5rem;">
      <a href="<?php echo esc_url( home_url( '/prom-quote/' ) ); ?>" class="btn btn-prom-quote">Get Your Prom Quote</a>
    </div>
