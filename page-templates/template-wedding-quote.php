...
<section class="page-hero">
  <div class="container">
    <h1>Get Your Wedding Quote</h1>
    <p>Tell us your date, venues and preferred vehicles. We provide fast, transparent pricing for Wedding car and Limousine hire.</p>
  </div>
</section>
    ...
    <div class="form-layout">
      ...
      <div class="quote-form-container">
        <div class="form-header">
          <h2>Request Your Wedding Quote</h2>
          <p>Complete the form below and we'll send your tailored Wedding transport quote within 24 hours during business hours.</p>
        </div>

        <form id="quoteForm" data-form-type="wedding">
          <?php wp_nonce_field( 'jp_quote_nonce', 'jp_nonce' ); ?>
          <input type="hidden" name="quoteType" value="wedding">
          ...
          <!-- Vehicle & Date -->
          <div class="form-section">
            <h3>Vehicle &amp; Wedding Date</h3>
            <div class="form-group">
              <label for="vehicleType">Choose Wedding Car *</label>
          ...
          <div class="form-section">
            ...
            <div class="form-group" style="margin-top:1rem">
                ...
                <textarea id="additionalStops" name="additionalStops" rows="2" placeholder="e.g. Pick up Mum at 12 Church Street BB1 1AA, drop at hotel, wheelchair access needed, bring child seat, etc."></textarea>
            </div>

          </div>

          <div class="form-actions">
            <button type="submit" class="btn primary large" style="width:100%">Get Wedding Quote</button>
      ...
      <div class="booking-info">
          ...
          <div class="process-steps">
            <div class="step">
              ...
              <div class="step-content">
                ...
                <p>Complete the form with your Wedding details and vehicle preferences.</p>
              </div>
            </div>
            <div class="step">
              ...
              <div class="step-content">
                ...
                <p>We'll send your tailored Wedding quote within 24 hours during business hours.</p>
              </div>
            </div>
            <div class="step">
              ...
              <div class="step-content">
                ...
                <p>Secure your date with a 25% deposit. Booking confirmation sent immediately.</p>
              </div>
            </div>
            <div class="step">
              ...
              <div class="step-content">
                ...
                <p>We'll contact you 48 hours before your Wedding to confirm all details.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="info-card">
          ...
          <ul class="included-list">
            ...
            <li>Wedding ribbon decoration</li>
            <li>Fuel and all driving costs</li>
            <li>Red carpet arrival service</li>
            <li>24/7 customer support on your Wedding day</li>
          </ul>
        </div>

        <div class="info-card contact-card">
          <h3>Need Help?</h3>
          <p>Speak to our Wedding booking specialists:</p>
...
<div id="successModal" class="success-modal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h2 id="modalTitle">Wedding Quote Submitted!</h2>
      <p>Thank you for choosing Just Phantoms. We'll send your Wedding transport quote within 24 hours during business hours.</p>
    </div>
